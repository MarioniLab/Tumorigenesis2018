...
```{r, fig.width=7, fig.height=7, warning=FALSE, message=FALSE}
features <- c("Csn2","Aldh1a3","Krt5","Col3a1","Cd74","Cited1","Krt8")
...
rmCells <- c(rmCells,sce.sub$barcode[sce.sub$SubCluster %in% c("4","12","10",
							       "7","13",
							       "15","16")])
```
...
sce$CellTypesFinal[sce$CellTypesFinal=="Lp1.Lp5.Lp6.Lp3.Lp9.Lp8"] <- "Lp"
sce$CellTypesFinal[sce$CellTypesFinal=="Avp.Lp11.Lp14"] <- "Avd"
