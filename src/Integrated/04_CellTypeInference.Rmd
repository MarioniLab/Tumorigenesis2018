...
sce$CellTypesFinal[sce$CellTypesFinal=="DcsMbe.Mcs5"] <- "Mcs1"
...
sce$CellTypesFinal[sce$CellTypesFinal=="Mp1Uk"] <- "Trm1" # These are merged as the only difference seems to be sequencing depth
