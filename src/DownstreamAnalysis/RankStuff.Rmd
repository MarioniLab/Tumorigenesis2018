...
fplot$Rankl <- logcounts(sce.full[,sce.full$CT %in% c("LpAv","Hs")])["Tnfsf11",]
...
ggsave(paste0(outdr,"Rankl-Csn2-Violin-Plot.pdf"),width=12,height=4)
```
...
ggplot(top, aes(x=logFC, y=-log10(FDR))) +
    ...
    geom_label_repel(data=top[1:20,], aes(label=Gene)) +
