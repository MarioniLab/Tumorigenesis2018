...
- The bottom group are all immune cells, with the top one (C3-C20) being myeloid and the bottom one (C17-C7) lymphoid
...
- All Cd45 positive (C2 and C20 are not, but express other markers of their respective lineages)
```{r, fig.width=7, fig.height=5, warning=FALSE, message=FALSE}
clust <- c("C1","C2","C3","C7","C10","C15","C16","C17","C20")
ggplot(pD, aes(x=UMAP1, y=UMAP2, color=ClusterLabels %in% clust)) +
    geom_point() +
    theme_void() +
    theme(legend.position="none") 
...
clust <- "C1"
ggplot(pD, aes(x=UMAP1, y=UMAP2, color=ClusterLabels==clust)) +
    geom_point() 
...
clust2 <- c("C2A"="NeutrophilA","C2B"="NeutrophilB","C2C"="NeutrophilC")
```
...
print(overviewPlot(m.sub,pD.sub,clust,"Dcstamp",dim1="Sub.tSNE1",dim2="Sub.tSNE2",
  variable="SubClusterLabels"))
clust3 <- c("C3A"="MacrophageA","C3B"="MacrophageB","C3C"="MacrophageC","C3D"="MacrophageD")
```
...
#C16D is cDC1 because of Itgae (Cd103), Cd8a and Irf8 some of which are activated due to expression of Ccr7 
print(overviewPlot(m.sub,pD.sub,clust,"Itgae",dim1="Sub.tSNE1",dim2="Sub.tSNE2", variable="SubClusterLabels"))
print(overviewPlot(m.sub,pD.sub,clust,"Irf8",dim1="Sub.tSNE1",dim2="Sub.tSNE2", variable="SubClusterLabels"))
print(overviewPlot(m.sub,pD.sub,clust,"Cd8a",dim1="Sub.tSNE1",dim2="Sub.tSNE2", variable="SubClusterLabels"))
#C16C is cDC2 because of Itgam (Cd11b)
print(overviewPlot(m.sub,pD.sub,clust,"Itgam",dim1="Sub.tSNE1",dim2="Sub.tSNE2", variable="SubClusterLabels"))
#C16B Ly6c positive, Ccr2 hi, Cd300 pos, cd244 pos, (?inflammtory DCs) 
print(overviewPlot(m.sub,pD.sub,clust,"Ly6c1",dim1="Sub.tSNE1",dim2="Sub.tSNE2", variable="SubClusterLabels"))
print(overviewPlot(m.sub,pD.sub,clust,"Cd300lf",dim1="Sub.tSNE1",dim2="Sub.tSNE2", variable="SubClusterLabels"))
print(overviewPlot(m.sub,pD.sub,clust,"Ccr2",dim1="Sub.tSNE1",dim2="Sub.tSNE2", variable="SubClusterLabels"))
#C16A
print(overviewPlot(m.sub,pD.sub,clust,"Sepp1",dim1="Sub.tSNE1",dim2="Sub.tSNE2", variable="SubClusterLabels"))
