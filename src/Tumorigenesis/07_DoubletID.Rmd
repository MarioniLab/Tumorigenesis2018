...
# Read in data
ddata <- readRDS("../../data/Tumorigenesis/Robjects/DoubletData.rds")
...
```{r, message=FALSE}
pD <- colData(readRDS("../../data/Tumorigenesis/Robjects/SCE_QC_norm.rds"))
pD <- data.frame(pD)
library(dplyr)
...
# Read in BC PCA
sce.cor <- readRDS("../../data/Tumorigenesis/Robjects/Corrected_preDoublet.rds")
...
```{r, message=FALSE, warning=FALSE}
m <- logcounts(readRDS("../../data/Tumorigenesis/Robjects/SCE_QC_norm.rds"))
