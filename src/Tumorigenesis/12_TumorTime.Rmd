...
# Load Data
sce <- readRDS("../data/Robjects/SCE_final.rds")
...
```{r, message=FALSE, warning=FALSE}
sce.full <- readRDS("../data/Robjects/SCE_final.rds")
...
```{r, message=FALSE, warning=FALSE}
dmba.data <- readRDS("../data/Robjects/DMBA_Bulk.rds")
pDat <- dmba.data[["pDat"]]
...
mnncor <- readRDS("../data/Robjects/CorrectedPCA.rds")
...
write.csv(out,"../data/Robjects/TumorTime.csv")
sessionInfo()
```
