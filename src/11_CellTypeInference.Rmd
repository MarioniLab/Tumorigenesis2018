...
clst <- read.csv("../data/Robjects/Clusters.csv",stringsAsFactors=FALSE)[,-1]
...
p.c <- ggplot(pD, aes(x=UMAP1, y=UMAP2)) +
    ...
    geom_point(data=pD.c,color="black")
p.g1 <- ggplot(pD, aes(x=UMAP1, y=UMAP2)) +
    geom_point(color="grey80") +
    geom_point(data=pD.g1,color="black")
p.g2 <- ggplot(pD, aes(x=UMAP1, y=UMAP2)) +
    geom_point(color="grey80") +
    geom_point(data=pD.g2,color="black")
p.g3 <- ggplot(pD, aes(x=UMAP1, y=UMAP2)) +
    geom_point(color="grey80") +
    geom_point(data=pD.g3,color="black")
