---
title: "Chlodronate Quality Control"
author: "Karsten Bach"
date: '`r Sys.Date()`'
output:
  html_notebook:
...
# Load Data
sce <- readRDS("../../data/Tumorigenesis/Robjects/SCE.rds")
sce <- sce[,sce$ChlodronateExperiment]
...
mt.outlier <- isOutlier(pD$prcntMito,nmads=5,type="higher")
...
sceout <- SingleCellExperiment(assays=list(counts=m),
			       colData=pD,
			       rowData=fD)
saveRDS(sceout,file="../../data/Tumorigenesis/Robjects/Chlodronate_SCE_QC.rds")
```
