...
# Load
mDat <- readRDS("../data/Robjects/ExpressionList_Mapped_fastMNN.rds")
m.cor <- mDat[["counts"]]
...
# for mamgland data
mDatanno <- read.csv("../data/Robjects/MammGland_Cluster.csv")
...
```{r, fig.width=10, fig.height=5, warning=FALSE, message=FALSE}
mamDat <- readRDS("../data/Robjects/MamGlandData_QCnormclustered.rds")
m2 <- mamDat[["counts"]]
