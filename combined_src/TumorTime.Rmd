...
For this we need to have a (per-sample) covariate that represents the process of tumorigenesis to a certain extent
The only one we have is the age of the animal.
Despite being highly correlated with the onset of tumorigenesis, the variability in latency would confound the analysis.
Hence, we want to estimate some sort of "biological time", potentially from the data.
...
sce <- sce[,!sce$Condition %in% c("CBLA0","CBLA1","CBLA2")]
