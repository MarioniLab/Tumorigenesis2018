...
# Removal of doublets
The following strategy for doubled removal was employed, mainly following an approach from \textit{Pijuana-Sala, Griffiths and Guibentif et al.}.
...
- Further I exclude two cluster that show expression of hemoglobin
```{r, message=FALSE, warning=FALSE}
library(ggrepel)
